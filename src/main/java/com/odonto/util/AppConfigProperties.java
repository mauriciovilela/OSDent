...
public class AppConfigProperties {
	...
	public ConfigOUT init() {
		...
		try {
			if (SessionContext.getInstance().getConfig() == null) {
				...
				final InputStream stream = new FileInputStream(tomcatDir + "/clinicaso.properties");
			...
			return SessionContext.getInstance().getConfig();
